...
class BaseTactileEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward, done, xy_info = self.get_step_data()

        self._observation = self.get_observation()

        return self._observation, reward, done, xy_info
    ...
    def get_visual_obs(self, save=False):
        """
        ...
        observation_ori = rgb_array[:, :, :3]
        observation = cv2.resize(observation_ori, (128, 128))
        if save:
            return observation, observation_ori
        return observation
    ...
    def get_observation(self):
        ...
        # observation['object_name'] = self._object_name
        return observation
    ...
    def render(self, mode="rgb_array"):
        ...
        _, rgb_array = self.get_visual_obs(save=True)
        ...
        # resize tactile to match rgb shape  
        height, width = rgb_array.shape[:2] 
        tactile_array = cv2.resize(tactile_array, (width, height))  
